  ...
  return (
    <header className='w-full sticky top-0 border-b bg-white z-50'>
      <nav className="container px-4 py-4 lg:py-0 lg:px-0 mx-auto flex justify-between items-center">
        <Link to={"../administrator/dashboard"} className='flex gap-2 items-center'>
        ...
        <div className='hidden lg:flex gap-8 h-full items-center'>
          <NavLink to={"dashboard"} className={`inline-block py-6 text-gray-500 border-b-4 border-white hover:text-[#FFDD66]`}>Dashboard</NavLink>
          <NavLink to={"orders"} className='inline-block py-6 text-gray-500 border-b-4 border-white hover:text-[#FFDD66]'>Orders</NavLink>
          <NavLink to={"account"} className='inline-block py-6 text-gray-500 border-b-4 border-white hover:text-[#FFDD66]'>Account</NavLink>
          <NavLink to={"settings"} className='inline-block py-6 text-gray-500 border-b-4 border-white hover:text-[#FFDD66]'>Settings</NavLink>
        </div>
      ...
      {mobileDrawerOpen && 
        <div className="fixed right-0 z-20 w-full bg-white p-12 flex flex-col justify-center items-center lg:hidden border-y">
          <ul>
            ...
            <li className='py-2 text-center'>
              <NavLink to={"settings"} className='text-gray-500 hover:text-[#FFDD66]'>Settings</NavLink>
            </li>
          </ul>
