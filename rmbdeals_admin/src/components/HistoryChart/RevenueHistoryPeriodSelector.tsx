...
const RevenueHistoryPeriodSelector = ({timeframe, period, setPeriod, setTimeFrame}:Props) => {
    const axios_instance_token = useAxiosToken()

    const historyPeriodsQuery = useQuery<number[]>({
        queryKey: ["summary", "revenue", "history", "periods"],
        queryFn: async() => await axios_instance_token.get(`/stats/revenue-history-periods`).then(res => res.data)
    })
    return (
...
export default RevenueHistoryPeriodSelector
